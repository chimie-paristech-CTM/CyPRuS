...
from model_fp_selection.lib.fingerprints import get_df_chemeleon_fp, get_input_chemeleon_fp
...
#parser.add_argument('--morgan', default=False, action='store_true', help='use Morgan FP instead of RDKit fingerprints')
parser.add_argument('--chemeleonfp', default=False, action='store_true', help='use CheMeleon FP instead of Morgan fingerprints')
